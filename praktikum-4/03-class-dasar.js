...
const mhs1 = new Mahasiswa("rachmad pamuji", "2025573029061", "Informatika");
const mhs2 = new Mahasiswa("mihtahuddin", "2025730105107", "Sistem Informasi");
const mhs3 = new Mahasiswa(
  "zafir amal maulana",
  "2025573010141",
  "Informatika",
);
...
const akun1 = new BankAccount("Miftahuddin", 500000);
const akun2 = new BankAccount("Zafir Amal Maulana", 300000);
